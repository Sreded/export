(function () {
  ...
  function compareEntries(a, b) {
    if (a.date && b.date) {
      ...
      if (difference !== 0) return els.sortSelect.value === "oldest" ? difference : -difference;
  ...
  function renderDatabaseDetails() {
    ...
    addDefinition(list, "Selected date field", state.detected && state.detected.fields.date ? state.detected.fields.date : "None recognized");
